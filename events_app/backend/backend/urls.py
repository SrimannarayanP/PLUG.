...
urlpatterns = [
    ...
    path('api/host/edit/<uuid:id>/', HostEventUpdateView.as_view(), name = 'host-event-edit'),
    ...
    # --- Payment Related ---
    path('api/events/verify-payment/', VerifyRazorpayPaymentView.as_view(), name = 'verify-payment'),
    path('api/webhook/razorpay/', RazorpayWebhookView.as_view(), name = 'razorpay-webhook'),
    path('api/events/cancel-pending-order/', CancelPendingOrderView.as_view(), name = 'cancel-pending-order'),
